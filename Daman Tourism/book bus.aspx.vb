...
Partial Class book_bus
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label13.Text = "Welcome" + "," + username + " " + "Lets book the bus.....!!!"
        cn.Close()
    End Sub
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        s = "insert into busbook(doj,dor,nop,mop,userid,busid) values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox12.Text & "','" & RadioButtonList1.SelectedValue & "','" & Label1.Text & "','" & Label12.Text & "')"
        cn.Open()
