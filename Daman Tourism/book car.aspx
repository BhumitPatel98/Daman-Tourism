<%@ Page Language="VB" AutoEventWireup="false" CodeFile="book car.aspx.vb" Inherits="book_car" %>
...
<body style="background-image:url('daman/beautiful-beach-hd-wallpaper-919.jpg');">
    ...
    <table style="width: 100%; height: 145px;">
        ...
        <center>
            <asp:Label ID="Label13" runat="server" CssClass="style3" style="font-family:Segoe Script;font-weight:bold;font-size:30pt;"
            Text="Label"></asp:Label></center>
        <br />
       
        <table style="width: 70%; height: 95px; margin-top: 0px; background-color: #FFFFFF;" 
            align="center">
            <tr>
                <td class="tdfont">
                    <asp:Label ID="Label2" runat="server" Text="You need the car on :"></asp:Label>
                </td>
                <td class="style10">
        ...
        <tr>
            ...
            <div style="align:center; text-align: center;"><asp:Button ID="Button1" runat="server" Text="Proceed" style="text-align: left" /></div>   
