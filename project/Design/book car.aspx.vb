...
Partial Class book_car
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label13.Text = "Welcome" + "," + username + " " + "Lets book the car.....!!!"
        cn.Close()
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim s1 As String = "select rate from car where cid='" & Label12.Text & "'"
        cn.Open()
        ...
        s = "insert into carbook(renton,returnon,nop,mop,nod,pay,cid,uid) values('" & TextBox1.Text & "','" & TextBox2.Text & "','" & TextBox12.Text & "','" & RadioButtonList1.SelectedValue & "','" & cal & "','" & rate & "','" & Label12.Text & "','" & Label1.Text & "')"
        cn.Open()
