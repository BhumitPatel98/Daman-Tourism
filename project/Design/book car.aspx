...
<body>
    ...
    <table style="width: 100%; height: 113px;">
        ...
        <center><asp:Label ID="Label13" runat="server" CssClass="style3" style="font-family:Segoe Script;font-weight:bold;font-size:20px;"
            Text="Label"></asp:Label></center>
        <br />
       
        <table style="width: 70%; height: 95px; margin-top: 0px;" align="center">
            <tr>
                <td class="tdfont">
