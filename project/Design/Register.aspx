...
<body style="height: 301px">
    ...
    <div style="height: 250px; width: 250px;border-radius:250px;font-family:Bernard MT Condensed;font-size:52px;color:#003366;top: 10px; right: 300px; bottom: 33px; left: 33px; position: relative; background-color: #FFFFFF;text-align:center"><br />Daman<br /> Tourism</div>
        ...
        <table style="border: thick solid #000000; width: 30%; height: 347px; top: 34px; left: 556px; position: absolute; background-color: #FFFFFF; margin-top: 0px;" 
            ...
            <tr>
                <td class="style5 round" colspan="2" style="color:#003366;">
                    <strong>Register&nbsp; Now</strong></td>
            </tr>
            <tr>
                <td class="style6">
                ...
                <td class="style8">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="TextBox1" ErrorMessage="*" CssClass="style12"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="TextBox1" ErrorMessage="Only text!" Display="Dynamic" 
                        ValidationExpression="^[a-zA-Z\s]+$" CssClass="style12"></asp:RegularExpressionValidator>
...
<option>Other</option>
                ...
                <td class="style9">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
                        ControlToValidate="dd1" InitialValue="0" ErrorMessage="*" style="color: #FF0000"  Display="Dynamic"></asp:RequiredFieldValidator>
            ...
            <tr>
                ...
                <td class="style10">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="TextBox3" ErrorMessage="*" CssClass="style12"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ControlToValidate="TextBox3" ErrorMessage="Invalid No." Display="Dynamic" 
                        ValidationExpression="[0-9]{10}" CssClass="style12"></asp:RegularExpressionValidator>
