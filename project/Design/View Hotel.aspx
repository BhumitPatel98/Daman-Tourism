...
<body>
            ...
            <tr>
                ...
                <td class="style5">
                    <asp:LinkButton ID="LinkButton1" runat="server" 
                       ...
                       v CssClass="style3">Home</asp:LinkButton>
                </td>
                <td class="style6">
    ...
    <asp:Label ID="Label1" runat="server" Text="Label" Visible ="false" ></asp:Label>
        <br />
        <center>
        <div style="background-color:White;height:1000px; width: 900px; border-radius:20px">
<asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1">
             ...
             <center><h1 style ="font-family:Bernard MT Condensed;font-size:60px;">
                ...
                <tr>
                <td class="image">
                 <asp:Image ID="Image1" runat="server" Height="180px" ImageUrl='<%# Eval("mimg") %>' Width="180px" style="border-radius:30px;border-width:2px;border-color:black;border-style:solid;"/>
                 </td>
                
                 <td class="image">
                 <asp:Image ID="Image2" runat="server" Height="180px" ImageUrl='<%# Eval("img2") %>' Width="180px" style="border-radius:30px;border-width:2px;border-color:black;border-style:solid;"/>
                 </td>
                       
                 <td class="image">
                 <asp:Image ID="Image3" runat="server" Height="180px" ImageUrl='<%# Eval("img3") %>' Width="180px" style="border-radius:30px;border-width:2px;border-color:black;border-style:solid;"/>
                 </td>
                       
                 <td class="image">
                 <asp:Image ID="Image4" runat="server" Height="180px" ImageUrl='<%# Eval("img4") %>' Width="180px" style="border-radius:30px;border-width:2px;border-color:black;border-style:solid;"/>
                 </td>
                 </tr>
                 </table>

                 <br /><br />
                    <font  style="font-family:Lucida Calligraphy;font-size:20px;color:gray">
...
<br /></font>
            ...
            <table>
            <tr>
            <td><asp:Repeater ID="rptBooks" runat="server">
        <ItemTemplate>
